        ...
        <div>
            <form onSubmit={handleSubmit} className='w-[500px] flex flex-col items-center justify-center gap-y-4'>
                <section className="container ">
                    <div className='bg-blue-300	 w-[500px] rounded-md p-4'>
                        <div {...getRootProps({ className: 'dropzone' })}>
                            <input {...getInputProps()} />
                            <p className='font-semibold text-[25px] text-center'>Drag and drop Monthly Report file here, or click to select files</p>
...
export default MonthlyReportFileUpload;
